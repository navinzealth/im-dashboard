        ...
        <div className="col-md-12" style={{ marginBottom: '20px' }}>
          <div className="row">
            ...
            <div className='col-md-2'>
              <Button variant="contained" color="success" style={{ padding: '10px 20px', fontSize: '13px', marginLeft: '10px' }}><AddIcon />  <Link href="/ListBanner/AddBanner" style={{ 'color': '#fff' }}>Add Media</Link></Button>
            </div>
          </div>
        </div>
        <div className='col-md-12'>
