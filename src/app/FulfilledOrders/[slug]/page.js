...
import PendingTreeTable from '../components/fulfilledTreeTable'
                       ...
                       {/*-------------------------------------------------------------------------------------------------------------------------- */}
                           <div className="row">
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                  <div className="input-field"><Input placeholder="Type in here…" variant="soft" size="lg" style={{padding:'12px 15px',fontSize:'15px'}} value={data.acceptedByName} disabled/></div>
                              </div>
                            </div>
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                  <div className="input-field"><Input placeholder="Type in here…" variant="soft" size="lg" style={{padding:'12px 15px',fontSize:'15px'}} value={data.acceptedById} disabled/></div>
                              </div>
                            </div>
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                  <div className="input-field"><Input placeholder="Type in here…" variant="soft" size="lg" style={{padding:'12px 15px',fontSize:'15px'}} value={data.qty} disabled/></div>
                              </div>
                            </div>
                           ...
                           {/* {careTaker.length > 0? 
                            ...
                            <div className='row'>
                              <div className='col-md-4'>
                              <Link variant="outlined" color="error" style={{width:'100%', fontSize:'15px',padding:'10px', display:'inline-block', textAlign:'center',border:'1px solid #000',color:'#000'}} href="/PendingOrders">  Back </Link>
                              </div>
                             </div>
