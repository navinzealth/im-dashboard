...
const headCells = [
  ...
  { id: 'cat_img', numeric: false, disablePadding: false, label: 'User ID', },
  { id: 'cat_name',  numeric: false, disablePadding: false, label: 'Project Id', },
  { id: 'cat_district',  numeric: false, disablePadding: false, label: 'Project Name', },
  { id: 'cat_state',  numeric: false, disablePadding: false, label: 'Gardener Name', },
  { id: 'cat_date',  numeric: false, disablePadding: false, label: 'Created on', },
  { id: 'cat_pincode',  numeric: false, disablePadding: false, label: 'Updated Tree', },
...
export default function FulfilledOrderTable() {
...
const fetchAllProjects=useCallback(()=>{
  ...
  let config = {
    ...
    url: `${apiRoute}/completedorderlist`,
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  <TableRow hover role="checkbox" aria-checked={isItemSelected}
                    ...
                    <TableCell align="left">{row.acceptedById}</TableCell>
                    <TableCell align="left">{row.projectId}</TableCell>
                    <TableCell align="left">{row.projectName}</TableCell>
                    <TableCell align="left">{row.acceptedByName}</TableCell>
                    ...
                    <TableCell align="left">{row.treeUpdated}</TableCell>
                    <TableCell align="left"><Link href={`FulfilledOrders/${row._id}`}><span className="dashboard-table-icon"><BorderColorIcon /></span></Link></TableCell>
                  </TableRow>
                );
              })}
