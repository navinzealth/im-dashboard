...
const headCells = [
  { id: 'cat_name',  numeric: true, disablePadding: false, label: 'Quiz Number', },
  { id: 'cat_img', numeric: true, disablePadding: false, label: 'Image', },
  { id: 'cat_published',  numeric: true, disablePadding: false, label: 'Coins', },
  { id: 'cat_description', numeric: true, disablePadding: false, label: 'Edit', },
];
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  <TableRow hover role="checkbox" aria-checked={isItemSelected}
                    ...
                    <TableCell align="right"><Link href={`Quiz/QuizListing/${row._id}`}>{row.quizNumber}</Link></TableCell>
                    ...
                    <TableCell align="right"><Link href={`/Quiz/QuizListing/QuizEdit/${row.quizId}`}><span className="dashboard-table-icon"><BorderColorIcon /></span></Link></TableCell>
                  </TableRow>
                );
              })}
