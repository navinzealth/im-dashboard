...
const headCells = [
  ...
  { id: 'cat_state',  numeric: false, disablePadding: false, label: 'Seeds', },
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  <TableRow hover role="checkbox" aria-checked={isItemSelected}
                    ...
                    <TableCell align="left">{row.treeSpecies}</TableCell>
                    <TableCell align="left">{row.seeds}</TableCell>
                    ...
                    <TableCell align="left"><Link href={`NewOrders/${row._id}`}><span className="dashboard-table-icon"><BorderColorIcon /></span></Link></TableCell>
                  </TableRow>
                );
              })}
