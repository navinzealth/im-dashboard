...
const headCells = [
  ...
  { id: 'cat_name',  numeric: true, disablePadding: false, label: 'Username', },
  { id: 'cat_description', numeric: true, disablePadding: false, label: 'Name',},
  ...
  return (
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography sx={{ flex: '1 1 100%' }} variant="h6" id="tableTitle" component="div" >  Caretakers </Typography>
      )}
    </Toolbar>
  );
}
                ...
                return (
                  <TableRow hover role="checkbox" aria-checked={isItemSelected}
                    ...
                    <TableCell align="right">
                      <div style={{position:'relative',width:'50px',height:'50px',borderRadius:'50%',border:'1px solid #e2e2e2',marginLeft:'auto',overflow: 'hidden'}}><Image src={row.userImage} alt="product image" width={50} height={50}/>
                      </div></TableCell>
                    ...
                    inputProps={{ 'aria-label': 'controlled' }} onChange={()=>changeCaretakerStatus(row)}/></TableCell>
                    ...
                    <TableCell align="right"><Link href={`caretakers/${row.userId}`}><span className="dashboard-table-icon"><BorderColorIcon /></span></Link></TableCell>
                  </TableRow>
                );
              })}
